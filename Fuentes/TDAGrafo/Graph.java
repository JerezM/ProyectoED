...
/**
 * Interface Grafo para grafos NO dirigidos considerando modificaciones para el Proyecto para examen libre(23-08-2019)
 * @author Jerez, M.
 */
public interface Graph<V, E> {
	 ...
	 * @param v Un vertice
	 * @param w Un vertice
	 * @return Verdadero si el vertice w es adyacente al vertice v, falso en caso
	 *         contrario.
